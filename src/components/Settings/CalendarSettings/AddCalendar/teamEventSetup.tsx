    ...
    <div>
      <div className="px-2 ">
        ...
        <div className=" h-full overflow-hidden px-4">
          <div className="lg:h-[55vh] xl:h-[40vh] 2xl:h-[45vh] overflow-y-scroll scrollbar-hide">
          ...
          <div className="lg:h-[20vh]">
            <div className="flex absolute bottom-4 right-4 justify-end gap-3 p-4 mt-2 border-t ">
              <button
                onClick={onClose}
