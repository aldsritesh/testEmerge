...
export default function StreetName({ updateData, onClose, actionData }: any) {
  const radioData = [{ title: "Contains", value: "contains" }];
              ...
              {radioData?.map((mainData: any, mainIndex: any) => (
                <li className="mb-1" key={mainIndex}>
                  ...
                  <p className="px-3 text-xs font-semibold text-gray-400 w-full">
                    Please enter just a street name without suffix or prefix.
                  </p>
                  <p className="px-3 text-xs font-semibold text-gray-400 w-full">
                    Example,Builder: If you want to search for St. John Road ,
                    just enter john to get proper results.
                  </p>
                </li>
              ))}
            </ul>
