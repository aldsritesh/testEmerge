...
export default function Phone({ updateData, onClose, actionData }: any) {
  const radioData = [
    { title: "Is", value: "isPhone" },
    { title: "Is Not", value: "isNotPhone" },
                    ...
                    <>
                      {mainData?.title == "Is" && (
                        <>
                          ...
                          />
                          <p className="px-3 text-xs font-semibold text-gray-400 w-full">
                            To Search contacts with international number ,
                            prefix your search with +zzz(where zzz means a
                            country dial code)
                          </p>
                        </>
                      )}
                    </>
                  ) : formValues.waitFor === "isNotPhone" ? (
                    <>
