...
export default function AttributionSessionSource({
  updateData,
  onClose,
  actionData,
}: any) {
        ...
        <form onSubmit={handleSubmit} className="flex flex-wrap px-2  ">
          <div className="w-full mt-4">
            <p className="w-full mb-2 text-sm text-gray-600 font-semibold fontStrawFord">
              Filter Attribution Session Source
            </p>
            ...
            <ul className="pt-2 ">
              {radioData?.map((mainData: any, mainIndex: any) => (
                <li className="mb-1" key={mainIndex}>
                  ...
                  <TextField
                    variant="outlined"
                    placeholder="Session Source"
                    type="text"
                    name="isSessionSource"
                    onChange={handleChange}
                    value={formValues.isSessionSource}
