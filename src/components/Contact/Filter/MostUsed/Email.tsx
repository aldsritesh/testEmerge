...
export default function Email({ updateData, onClose, actionData }: any) {
  const radioData = [
    { title: "Is", value: "isEmail" },
    { title: "Is Not", value: "isNotEmail" },
