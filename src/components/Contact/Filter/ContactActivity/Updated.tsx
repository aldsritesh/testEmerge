...
export default function Updated({ updateData, onClose, actionData }: any) {
  const radioData = [
                      ...
                      {mainData.title === "Less Than" && (
                        <div className="flex items-center">
                          ...
                          <Select
                            name="lessThanSelect"
                            onChange={handleChange}
                            className="border-none outline-nonerounded-lg  mb-2  text-sm font-medium bg-transparent focus:bg-transparent w-3/4 placeholder-dark   text-space focus:outline-none focus:border-gray-300 text-black"
                          >
                            <MenuItem value="">Select </MenuItem>
                            <MenuItem value="min">Minutes Ago</MenuItem>
                            <MenuItem value="hours">Hours ago</MenuItem>
