...
export default function UnbearablePain({
  updateData,
  onClose,
  actionData,
}: any) {
                  ...
                  <div className="flex  flex-col  ">
                    <div className="dropdown">
                      <label tabIndex={0} className=" ">
                        ...
                        >
                          Select How UnbearablePain is this pain , on a scale of
                    ...
                    {show ? (
                      <span className=" text-red-500 text-xs font-semibold px-3 py-2">
                        *At least one how UnbearablePain is this pain , on a
                        scale of 1-5 ? 5 being the worst?
                      </span>
                    ) : (
                      <div>
