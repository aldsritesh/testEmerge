...
export default function PainCause({ updateData, onClose, actionData }: any) {
                  ...
                  <div className="flex  flex-col ">
                    <div className="dropdown">
                      <label tabIndex={0} className=" ">
                        ...
                        >
                          <span className="w-[95%]">
                            Select Is this pain caused by a chronic condition ?
                          </span>{" "}
                    ...
                    {show ? (
                      <span className=" text-red-500 text-xs font-semibold px-3 py-2">
                        *At least one Is this pain caused by a chronic condition
                        ?
                      </span>
                    ) : (
                      <div>
