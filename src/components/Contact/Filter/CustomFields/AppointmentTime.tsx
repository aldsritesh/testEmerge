                  ...
                  <div className="flex  flex-col ">
                    <div className="dropdown">
                      <label tabIndex={0} className=" ">
                        ...
                        >
                          <span className="w-[95%]">
                            Select I have just one last thing to ask before we
                            confirm your Appointment time. That said, our
                            doctors and staff are committed to helping people
                            who are committed to bettering their health and
                            wellness. Will you be able to commit to the time I
                            schedule with you today?
                          </span>{" "}
                    ...
                    {show ? (
                      <span className=" text-red-500 text-xs font-semibold px-3 py-2">
                        *At least one I have just one last thing to ask before
                        we confirm your Appointment time. That said, our doctors
                        and staff are committed to helping people who are
                        committed to bettering their health and wellness. Will
                        you be able to commit to the time I schedule with you
                        today?
                      </span>
                    ) : (
                      <div>
