...
export default function PainType({ updateData, onClose, actionData }: any) {
                  ...
                  <div className="flex  flex-col  ">
                    <div className="dropdown ">
                      <label tabIndex={0}>
                        ...
                        >
                          Select Where are you experiencing pain ?
                    ...
                    {show ? (
                      <span className=" text-red-500 text-xs font-semibold px-3 py-2">
                        *At least one where are you experiencing pain ? pain ?
                      </span>
                    ) : (
                      <div>
