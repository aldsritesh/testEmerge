...
const SMSMessage = ({ handleChange, onClose }: any) => {
  ...
  const { messageText, setMessageText } = useContext(CnvContext);
  const {
  ...
  useEffect(() => {
    setContent(content + messageText.replace(/<\/?[^>]+(>|$)/g, ""));
    if (messageText != "") {
      setMessageText("");
    }
      ...
      <div className="bg-white w-full px-5 pt-2">
        <div className="w-full relative ">
          <textarea
            ...
            rows={5}
            placeholder="Type in your message and press ENTER to send..."
          ...
          <div className="absolute right-3 top-3">
            <div className="flex flex-col justify-between items-center   ">
              ...
              <button
                onClick={() => {
                  setActiveData("template");
                  setTemplateModalVisibility(!templateModalVisibility);
                }}
                className="mb-2"
              >
                <BsFileEarmarkText
                  className={` ${
                    activeData == "template" ? "text-blue-500" : "text-gray-500"
                  } h-5 w-5`}
                />
              </button>
            </div>
        ...
        <div className="flex flex-wrap justify-between items-center mt-2 mb-2 px-2">
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex gap-2">
              <button
                ...
                className="bg-red-600 px-3 py-1.5 rounded-md w-28 flex justify-center"
              >
          ...
          <div className="flex flex-wrap justify-between items-center">
            ...
            <button
              ...
              className="ml-2 bg-newBlue px-3 py-1.5 rounded-md flex justify-between items-center"
            >
