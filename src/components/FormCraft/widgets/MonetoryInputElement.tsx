...
export const MonetoryInputElement = ({
  text,
  color = "#000000",
  textInputProps,
    ...
    >
      ...
      <div className="mb-5 mr-10">
        <label className="relative block">
          <span className="absolute inset-y-0 left-1 flex items-center pr-2 text-slate-300">
            $
          </span>
          <input
            disabled={!editable}
            className={`flex border-gray-300 border-2 bg-[#f6f6fc] shadow pl-8 py-2  rounded-md w-full focus-within:outline-2 focus-within:outline-blue-400 ${shadow} ${borderType} ${borderColor}`}
            style={{
              color: color,
              borderRadius: borderRadius + "px",
              backgroundColor,
          ...
          />
          <span className="absolute inset-y-0 right-5 flex items-center pr-2 text-slate-300">
            USD
          </span>
        </label>
      </div>
