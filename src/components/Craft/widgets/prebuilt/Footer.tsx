...
export const FootersText = ({ children }: any) => {
  const {
    connectors: { connect },
  }: any = useNode();
  return (
      ...
      <div ref={(ref: any) => connect(drag(ref))}>
        <div
          className={`w-full h-auto ${size} mr-2 ${
            hovered && "hover:outline-blue-500 hover:outline z-50"
        ...
        >
          {hovered && (
            <>
              ...
              <div
                className="absolute bottom-[-10px] left-[48%]  text-white text-xs px-1 z-50"
                onClick={() => {
          ...
          <div>
            <div className="flex mx-8 justify-evenly items-center">
              <Element id={`FootersText0`} is={FootersText} canvas>
              ...
              {items.map((item: any, index: any) => (
                <div key={index} className="">
                  <Element
                    id={`FootersText${index + 1}`}
                    is={FootersText}
                    canvas
                  >
                    <footer className="bg-white  0">
                      <div className="mx-auto w-full max-w-screen-xl ">
                        <div className="flex gap-8 px-4 py-6 lg:py-8 md:grid-cols-4 ">
                          {/* <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
                          <Text
                            alignment="left"
                      ...
                      {/* <div className="px-4 py-6 flex justify-center bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            ...
            <div className="py-6 flex justify-center bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
              <div className="flex mt-4 space-x-6 justify-center md:mt-0">
                <a
                  href="#"
                  className="text-gray-400 hover:text-gray-900 dark:hover:text-white"
          ...
          {/* <Element id="FootersText" is={FootersText} canvas>
...
const FootersSettings = () => {
  ...
  const textNodeSettings =
    state.nodes[state.nodes[data.linkedNodes["FootersText1"]].data.nodes[0]]
      .related.settings;
  return (
    <div>
      <div className="flex justify-between items-center">
        <label className="text-sm text-gray-400">Add new footer list</label>
        <button
      ...
      {props.items.map((item: any, index: number) => (
        ...
        >
          <h2 className="text-gray-400 text-sm ">{`New List${index}`}</h2>
          <button
            className="btn bg-transparent btn-xs border-none hover:border-none hover:bg-transparent"
            onClick={() =>
