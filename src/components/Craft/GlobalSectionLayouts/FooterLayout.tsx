...
export const GlobalFootersText = ({ children }: any) => {
  const {
    connectors: { connect },
  }: any = useNode();
  return (
...
export const GlobalFooterLayout = ({
  size,
  ...
  return (
    <div ref={(ref: any) => connect(drag(ref))}>
      ...
      >
        ...
        <Element id="FootersText" is={GlobalFootersText} canvas>
