...
const elementName = "PractoNavbar";
...
interface IPractoNavbarProps extends ICommonSettingsProps {
  size?: string;
  padding?: number;
  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <Element id="logoImage" is={PractoNavbarLogo} canvas>
            <BuilderImage
              width={100}
              height={50}
              type="contain"
              imageSrc={require("../../../../../public/images/Practro/logo.png")}
            />
          </Element>
        </div>
        <div className=" flex">
          <div className="flex items-center gap-4 pr-3 font-normal  ">
          ...
          {/* <div>
            <Element id="PractoButton" is={PractoNavbarButton} canvas>
              <Button
                backgroundColor="#9c70a5"
                color="white"
                text="Contact"
                borderRadius={10}
                paddingRight={25}
...
const PractoNavbarSettings: any = () => {
  const {
    actions: { setProp },
    props,
    id,
...
export const PractoNavbarLogo = ({ children }: any) => {
  const {
    connectors: { connect },
  }: any = useNode();
  return (
...
export const HeaderMenuPracto = ({ children }: any) => {
  const {
    connectors: { connect },
  }: any = useNode();
...
export const PractoNavbarButton = ({ children }: any) => {
  const {
    connectors: { connect },
  }: any = useNode();
  return <div ref={connect}>{children}</div>;
