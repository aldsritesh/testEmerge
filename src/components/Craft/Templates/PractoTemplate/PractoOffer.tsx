...
interface IPractoOfferProps extends ICommonSettingsProps {
    ...
    <>
      ...
      >
        ...
        <div className="w-fit flex items-end  justify-start gap-1">
          <div className="w-fit">
            <Element id="PractoOfferTitle" is={PractoOfferText} canvas>
              <Text
                alignment="left"
                lineHeight={1.1}
                text="What We Offer"
          ...
          <div className="w-10 ">
            <Element id="AcuAboutusLine" is={PractoOfferText} canvas>
...
PractoOffer.craft = {
  ...
  props: {
    ...
    cardData: [
      {
        id: 1,
        heading: "ChiroPractic Therapy",
        desc: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusa nt ium dolor emque laudantium totam.",
        image: require("../../../../../public/images/Practro/service1.webp"),
        button: "READ MORE",
      },
      {
        id: 2,
        ...
        desc: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusa nt ium dolor emque laudantium totam.",
        image: require("../../../../../public/images/Practro/service2.webp"),
        button: "READ MORE",
      },
      {
        id: 3,
        ...
        desc: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusa nt ium dolor emque laudantium totam.",
        image: require("../../../../../public/images/Practro/service3.webp"),
        button: "READ MORE",
      },
      {
        id: 4,
        ...
        desc: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusa nt ium dolor emque laudantium totam.",
        image: require("../../../../../public/images/Practro/service4.webp"),
        button: "READ MORE",
      },
      {
        id: 5,
        heading: "Physiptherapy",
        desc: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusa nt ium dolor emque laudantium totam.",
        image: require("../../../../../public/images/Practro/service1.webp"),
        button: "READ MORE",
      },
...
export const PractoOfferText = ({ children }: any) => {
  const {
    connectors: { connect, drag },
  }: any = useNode();
  return (
...
export const PractoOfferImage = ({ children }: any) => {
  const {
    connectors: { connect },
  }: any = useNode();
  return (
