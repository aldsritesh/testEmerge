...
export const PhysioFooter = ({
  ...
  const PhysioFooterData = [
    {
      listName: "Quick Links",
      id: "FooterQuickLinks",
      listItem: [
        { item: "Home", id: "list1" },
        { item: "About Us", id: "list2" },
        { item: "Request Call Back", id: "list3" },
        { item: "Testimonials", id: "list4" },
        { item: "Contact Us", id: "list5" },
      ],
    },
    {
      listName: "Symptom",
      id: "FooterSymptom",
      listItem: [
        { item: "Neck Pain", id: "list6" },
        { item: "Head Pain", id: "list7" },
        { item: "Back Pain", id: "list8" },
        { item: "Whiplash", id: "list9" },
        { item: "Work Injury", id: "list10" },
      ],
    },
    {
      listName: "Follow Us On",
      id: "FooterFollowOn",
      listItem: [
        { item: "FaFacebook", id: "list11" },
        { item: "BsTwitter", id: "list12" },
        { item: "FaLinkedin", id: "list13" },
        { item: "© 2025 Physio", id: "list14" },
      ],
    },
  ];
  // {
  ...
  // },
  // {
  //   listName: "Get in Touch",
  //   id: "FooterGetInTouchList",
  //   listItem: {
  //     id: "GetInTouchList",
  //     items: {
  //       item1: "+012 (345) 678 99",
  //       item2: "contact@physio.com",
  //       item3: "121 Lato Street, Melbourne, PAT 3000",
  //     },
  //   },
  // },
            ...
            <div className="container mx-auto flex-col">
              <div className="-mx-4 flex justify-evenly px-5 pt-10">
                <div className="flex justify-evenly px-4 ">
                  ...
                  {/* three div wrap quick symptom GetinTouch start */}
                  <div className=" flex  w-full ">
                    {PhysioFooterData?.map((footerData: any, index: number) => (
                      <div
                        className="w-full px-4 sm:w-1/4 lg:w-4/12 "
                        key={index}
                      >
                        <div className="mb-10 w-full">
                          ...
                          {/* <li>
                                <a className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                                  <Text
                                    alignment="left"
                                    text={footerData?.listItem?.items?.item2}
                                    fontSize={15}
                                    bold="font-medium"
                                  />
                                </a>
                              ...
                              <li>
                                <a className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                                  <Text
                                    alignment="left"
                                    text={footerData?.listItem?.items?.item3}
                                    fontSize={15}
                                    bold="font-medium"
                                  />{" "}
                                </a>
                              ...
                              <li>
                                <a className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                                  <Text
                                    alignment="left"
                                    text={footerData?.listItem?.items?.item4}
                                    fontSize={15}
                                    bold="font-medium"
                                  />
                                </a>
                              ...
                              <li>
                                <a className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                                  <Text
                                    alignment="left"
                                    text={footerData?.listItem?.items?.item5}
                                    fontSize={15}
                                    bold="font-medium"
                                  />
                                </a>
                  ...
                  {/* three div wrap quick symptom GetinTouch end */}
                </div>
              </div>
              <div>
                <div className="w-full px-4 sm:w-1/2 lg:w-full">
                  <Element is={PhysioFooterText} id="FooterIcon" Canvas>
