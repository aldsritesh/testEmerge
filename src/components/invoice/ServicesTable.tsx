...
const ServicesTable = () => {
  const [tableData, setTableData] = useState<any>([
    {
      id: "1",
      service_name: "Design Asset Promo",
    ...
    {
      id: "2",
      service_name: "Analysing the Witches",
      desc: "Lorem, ipsum dolor sit amet consectetur ",
      cost: "$100.000",
      code: 12,
      retail: "$10.000",
    ...
    {
      id: "5",
      service_name: "English Exam Practise",
      desc: "Lorem, ipsum dolor sit amet consectetur ",
      cost: "$100.000",
      code: 12,
      retail: "$10.000",
    ...
    {
      id: "6",
      service_name: "Muscular Endurance",
      desc: "Lorem, ipsum dolor sit amet consectetur ",
      cost: "$100.000",
      code: 12,
      retail: "$10.000",
  ...
  const filteredData = tableData.filter((row: any) => {
    if (filterInput.type === "search") {
      ...
      return (
        row.service_name.toLowerCase().includes(value) ||
    ...
    <>
      ...
      <div className="px-4 border border-b-0 rounded-lg pb-10">
        ...
        <div className="w-full h-16  flex items-center   ">
          <h1 className="text-3xl font-semibold  pt-3">Services</h1>
        </div>
