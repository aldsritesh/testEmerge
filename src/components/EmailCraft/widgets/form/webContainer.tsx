...
import { CommonSettings, ICommonSettingsProps, baseDefaults, getCommonSettingsProps } from "../CommonSettings";
...
export default function WebContainer({
  ...
  return (
    <div
      ...
      className={`border-gray-500 overflow-y-scroll scrollbar-hide ${borderType} ${shadow} shadow-[${shadowColor}] ${
