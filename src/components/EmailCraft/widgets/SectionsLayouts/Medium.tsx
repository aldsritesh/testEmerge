...
import MediumWidthContainer from "../MidiumWidthContainer";

// import MediumWidthContainer from "../widgets/FullWidthContainer";
...
const MediumWidth = ({
  ...
  return (
    <div
      className="bg-white outline-1 outline-dashed my-1 p-2 w-full flex justify-center"
