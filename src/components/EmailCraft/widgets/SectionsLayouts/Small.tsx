...
const SmallWidth = ({
  ...
  return (
    <div
      className="bg-white p-2 outline-dashed my-2 outline-1 w-full flex justify-center"
    ...
    >
      ...
      >
        {hovered && (
          <div>
            <div className="absolute  -bottom-4 -right-[30%] bg-green-500 text-white text-[10px] px-1 z-50 capitalize">
              {elementName}
            </div>
          </div>
        )}
