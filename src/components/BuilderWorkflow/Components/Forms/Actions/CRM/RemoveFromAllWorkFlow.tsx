...
export default function RemoveFromAllWorkFlow({ onDataStore, onClose }: any) {
        ...
        <form onSubmit={handleSubmit} className="flex flex-wrap px-2  ">
          ...
          <div className="w-full">
            <div className="flex justify-start items-center   mb-3   rounded-lg">
              ...
              />
              <p
                className={`w-full mb-2 text-sm text-gray-600 font-semibold fontStrawFord mt-2 ml-2 `}
              >
