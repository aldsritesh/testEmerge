...
export default function ManualSMS({ onDataStore, onClose }: any) {
        ...
        <form onSubmit={handleSubmit} className="flex flex-wrap px-2  ">
          ...
          <div className="w-full mt-4">
            ...
            <Select
              ...
              rounded-md mt-2 mb-2 text-sm font-medium bg-transparent focus:bg-transparent w-full placeholder-dark  text-space focus:outline-none focus:border-none text-black"
            >
          ...
          <div className="w-full mt-1.5">
            ...
            <div className="flex justify-between">
              <input
                ...
                className="w-2/3 placeholder:text-gray-400 text-gray-500 text-[12px] px-3 rounded-md mt-2 mb-2 py-3.5 font-medium bg-transparent focus:bg-transparent   border-[1px] border-gray-200 text-space focus:outline-none focus:border-gray-300  "
              />
