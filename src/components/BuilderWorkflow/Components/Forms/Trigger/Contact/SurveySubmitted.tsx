...
const appointmentFilter = [
  {
    title: "Disqualified",
    subContent: [{ title: "Is True" }, { title: "Is False" }],
  },
  {
    title: "Survey is",
    subContent: [{ title: "Evaluation" }],
  },
];
...
export default function SurveySubmitted({ onClose, updateData }: any) {
