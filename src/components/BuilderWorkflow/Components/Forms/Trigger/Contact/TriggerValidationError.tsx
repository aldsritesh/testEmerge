...
const appointmentFilter = [
  {
    title: "Error is",
    subContent: [{ title: "Not Valid" }, { title: "SMS Incapable" }],
  },
];
      ...
      <div className="h-[74vh] 2xl:h-[76vh] mt-2 overflow-y-scroll scrollbar-hide px-2">
        <form onSubmit={handleSubmit}>
          <div className="w-full mb-5 mt-4">
            ...
            <TextField
              placeholder="Trigger Validation Error"
              variant="outlined"
              type="text"
              id="workflowName"
              name="workflowName"
              ...
              {filter.filterstype && (
                <div className="w-full  md:w-[45%] pr-4">
                  ...
                  <Select
                    ...
                    onChange={(e) => handleInputChange(e, index)}
                    className="border-none outline-none rounded-lg mt-2 mb-2  text-sm font-medium bg-transparent focus:bg-transparent w-full placeholder-dark   text-space focus:outline-none focus:border-none text-black"
                  >
                    <MenuItem value="">Select</MenuItem>
                    {filter.filterstype &&
                      appointmentFilter
