...
const appointmentFilter = [
  ...
  },
  {
    ...
    subContent: [
      {
        title: "Disable DND for all channels",
      },
      {
        title: "Disable DND for special channels",
      },
      {
        title: "Enable DND for all channels",
      },
      {
        title: "Enable DND for special channels",
      },
    ],
  },
];
