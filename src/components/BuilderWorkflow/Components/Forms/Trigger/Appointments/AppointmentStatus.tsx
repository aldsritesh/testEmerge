...
const AppointmentStatus = ({ onClose, updateData, initialData }: any) => {
            ...
            >
              <div className="w-full  md:w-[45%] pr-4">
                ...
                <Select
                  ...
                  name="filterstype"
                  defaultValue={filter.filterstype}
                  ...
                  {filter.filterstype &&
                    appointmentFilter
                      ...
                      ?.subContent.map((subOption, subOptionIndex) => (
                        <MenuItem key={subOptionIndex} value={subOption.title}>
                          {subOption.title}
                        </MenuItem>
                      ))}
                </Select>
