...
import {
  ClientSaysCard,
  ClientSaysCardData,
} from "@/components/Craft/widgets/ClientSaysCard";
...
import { AcuFooter } from "@/components/Craft/Templates/AcupuntureTemplate/Acufooter";
import {
  AcuFeaturedServices,
...
import {
  PractoTemplate,
  PractoTemplateSection,
} from "@/components/Craft/TemplateSection/PractoTemplate";
import {
  GlobalRequestForm,
...
import {
  ...
  PractoBannerButton,
  PractoBannerText,
} from "@/components/Craft/Templates/PractoTemplate/PractoBanner";
  ...
  return (
    <CraftContext.Provider value={value}>
      <div className="h-full overflow-hidden">
        <Editor
          enabled={stateToLoad.fromIframe ? false : true}
          resolver={{
            CPTCodeSelect,
            CPTSelectElement,
            App,
        ...
        >
          ...
          {!stateToLoad.fromIframe ? selectHeading == 1 && <SeoSettings /> : ""}
        </Editor>
      </div>
