  ...
  return (
    <div className="w-full relative overflow-hidden flex justify-between items-center flex-col">
      <div
        ...
        }  fixed top-28 lg:top-0 left-0  flex bg-white overflow-y-scroll scrollbar-hide flex-col justify-between   pl-0 w-[50%] md:w-[30%] lg:w-full  bg-auth shadow-md    lg:relative   z-40  ease-in-out duration-300 `}
      >
              ...
              <ul>
                {item?.subContent?.map((mainData: any, mainIndex: any) => (
                  <li key={mainIndex} className={`mb-3  pl-1 w-full`}>
                    ...
                    text-[14px] 2xl:text-[15px] font-semibold tracking-wide  ml-5`}
                        >
                          {mainData.title}
                        </span>
                      </div>
        ...
        <div
          className={`mb-10 lg:mb-3 xl:mb-6 2xl:mb-[-5px] 3xl:mb-0  pl-1 w-full py-1`}
        >
          <Link href="/settings">
            <div
